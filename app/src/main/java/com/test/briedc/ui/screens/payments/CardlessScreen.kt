...
@Composable
fun CardlessScreen(datas: DetailTransaction?, context: Context, navHostController: NavHostController) {
    ...
    ConstraintLayout(
        ...
        Image(
            ...
            modifier = Modifier
                .constrainAs(intro_1) {
                    bottom.linkTo(nfc_icon.top, margin = 10.dp)
        ...
        AnimatedVisibility(
            ...
            Text(
                text = "Tap dan Tahan disini \nKartu atau Handphone anda.",
        ...
        Image(
            painter = painterResource(R.drawable.ic_nfc_circle),
            contentDescription = null,
            modifier = Modifier
                .constrainAs(nfc_icon) {
                    bottom.linkTo(cmp_tap.top, margin = (-25).dp)
                    start.linkTo(parent.start)
                    end.linkTo(parent.end)
                }
                .height(100.dp),
        ...
        Column(
            ...
            // Nama & nomor kartu
            Text(
                text = "Ghaushil Badri Amin | 0290 3445 9681 112",
                style = AppTheme.typography.titleMedium,
...
@Composable
fun CardlessScreenPreview() {
    AppTheme {
        val context = LocalContext.current
        val navHostController = NavHostController(context)
        CardlessScreen(null, context, navHostController)
    }
}